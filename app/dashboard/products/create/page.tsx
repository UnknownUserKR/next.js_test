            ...
            <Card className="mt-5">
                ...
                <CardContent>
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="flex flex-col gap-3">
                            <Label>Price</Label>
                            <Input key={fields.price.key} name={fields.price.name} defaultValue={fields.price.initialValue} type="number" placeholder="$0.00" />
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            {images.length > 0 ? (
                                <div className="flex gap-5">
                                    {images.map((image, index) => (
                                        <div key={index} className="relative w-[100px] h-[100px]">
                                            ...
                                            <Button onClick={() => handleDelete(index)} type="button" className="absolute -top-3 -right-3 bg-red-500 p-2 rounded-lg text-white w-8 h-8">
                                ...
                                <UploadDropzone appearance={{
                                    button:"ut-ready:bg-pink-600 ut-uploading:cursor-not-allowed bg-red-500 bg-none after:bg-orage-400"
                                }} className="ut-label:text-pink-600" endpoint="imageUploader" onClientUploadComplete={(res) => {
